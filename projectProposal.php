				...
				<div class="wrap-contact100" style="margin-top: 80px;">
					<div class="contact100-form-title" style="background-image: url(assets/images/bg_proposal.jpg);">
						<span class="contact100-form-title-1">
							<b>أضف مقترح مشروعك هنا</b> 
						</span>
					</div>

					<form method="post"  action="projectProposal.php" class="contact100-form validate-form">
						<div class="wrap-input100 validate-input" data-validate="Name is required">
							<span class="label-input100" style="position: initial; float: right;">:عنوان المشروع</span>
							<input class="input100" style="text-align: right;" type="text" name="title" placeholder=" ...أدخل عنوان مشروعك">
						...
						<div class="wrap-input100 validate-input" data-validate = "Message is required">
							...
							<textarea class="input100" style="text-align: right;" name="proposal" placeholder=" ...أوصف مشروعك بما قل ودل" rows="20"></textarea>
							<span class="focus-input100"></span>
						</div>

						<div class="container-contact100-form-btn">
							<button name="send_proposal" class="contact100-form-btn">
								<span>
	...
	if (isset($_POST['send_proposal'])) {
		...
		if (count($errors) == 0) {
			...
			if (isset($_SESSION['UserName'])) {
				...
				$user = new User();
				$results = $user->ptojectProposal($title,$proposal,$date,$username);
			}
			if ($results) {
